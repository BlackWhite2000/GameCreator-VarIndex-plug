...
class CustomCommandParams_15001 {
    varType: number; // = 0;  
    varG: boolean; // = false; 二周目
    varGetNum: number; // = 0; 输出至
    varGetStr: number; // = 0; 输出至
    varGetBlo: number; // = 0; 输出至
    varGetNumG: number; // = 0; 输出至
    varGetStrG: number; // = 0; 输出至
    varGetBloG: number; // = 0; 输出至
    varIndex: number; // = 0; 索引值
    varIndexG: number; // = 0; 索引值
}
